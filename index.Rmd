...
| First Steps |  [Workthrough in R](R_FirstSteps.html), [Video](https://youtu.be/fPRcu9g7ZTQ) | [STATS19_GM_AccData.csv](data/STATS19_GM_AccData.csv)
| Loading Data | Workthrough: [Workthrough in R](R_DataDownload.html) | [mroz.csv](data/Mroz.csv), [mroz.xlsx](data/Mroz.xlsx)
| Basic Data Analysis | Workthrough: [Workthrough in R](R_BasicDataAnalysis.html) | [mroz.csv](data/Mroz.csv)
| Basic Data Analysis (Tidyverse) | Workthrough: [Workthrough in R](R_SummaryStatsTidyverse.html) | [mlb1.csv](data/mlb1.csv) 
...
| Topic | Workthrough | Data used |
|:------|:-----|:-----|
| Basic Data Visualisation (ggplot) | Workthrough: [Workthrough in R](R_GraphIntro.html) | [mlb1.csv](data/mlb1.csv) 

# Regression models and related techniques

| Topic | Workthrough | Data used |
|:------|:-----|:-----|
| Basic regression models | Workthrough: [Workthrough in R](R_RegressionIntro.html) | [WBdata.Rdata](data/WBdata.Rdata) 

## Dealing with Time-Series variables

| Topic | Workthrough | Data used |
|:------|:-----|:-----|
| Basic TS modeling | Workthrough: [Workthrough in R](R_TS_Modelling.html) | [EUROSTATtimeseries.csv](data/EUROSTATtimeseries.csv) 
...
You can find [further resources here](resources.html).
