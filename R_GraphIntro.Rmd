...
Let's get a dataset to look at. We shall use the Baseball wages dataset, [mlb1.csv](data/mlb1.csv). Make sure that it is saved into your working directory. (Recall, use `setwd()` to set your working directory).
