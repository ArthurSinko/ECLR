...
For this computer lab we are using the datafile [STATS19_GM_AccData.csv](data/STATS19_GM_AccData.csv). You should download this datafile into the folder you just created and want to work from. It will also be useful to have the [Data Dictionary](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/995422/stats19.pdf) ready.
