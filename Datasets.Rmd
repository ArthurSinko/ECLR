...
## mroz dataset ([mroz.csv](data/Mroz.csv) )
...
## Major League Baseball ([mlb1.csv](data/mlb1.csv))
...
## Greater Manchester accident data ([STATS19_GM_AccData.csv](data/STATS19_GM_AccData.csv))
